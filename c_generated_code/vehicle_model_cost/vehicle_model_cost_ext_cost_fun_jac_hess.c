...
/* vehicle_model_cost_ext_cost_fun_jac_hess:(i0[7],i1[2],i2[0],i3[7])->(o0,o1[9],o2[9x9,5nz],o3[],o4[0x9]) */
...
CASADI_SYMBOL_EXPORT int vehicle_model_cost_ext_cost_fun_jac_hess_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
