...
static const casadi_int casadi_s5[3] = {0, 7, 1};

/* vehicle_model_cost_ext_cost_e_fun_jac_hess:(i0[7],i1[0],i2[0],i3[7])->(o0,o1[7],o2[7x7,3nz],o3[],o4[0x7]) */
...
CASADI_SYMBOL_EXPORT int vehicle_model_cost_ext_cost_e_fun_jac_hess_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
